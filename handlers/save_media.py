...
async def SaveBatchMediaInChannel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Sruja_12_{str_to_b64(str(SaveMessage.message_id))}"
        await editable.edit(
...
async def SaveMediaInChannel(bot: Client, editable: Message, message: Message):
    try:
        ...
        share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Sruja_12_{str_to_b64(file_er_id)}"
        await editable.edit(
